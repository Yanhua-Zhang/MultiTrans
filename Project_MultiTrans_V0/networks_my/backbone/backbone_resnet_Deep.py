...
__all__ = ['resnet18_Deep', 'resnet50_Deep', 'resnet101_Deep']      
...
def resnet18_Deep(pretrained=True, **kwargs):
...
def resnet50_Deep(pretrained=True, **kwargs):
...
def resnet101_Deep(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(
            "/home/zhangyanhua/Code_python/model_pretrained/resnet101-deep.pth", map_location='cpu'))
    return model


def resnet152_Deep(pretrained=True, **kwargs):
